"""Placeholder test for the matching module.
...
import app.modules.matching as module


def test_the_public_surface_is_the_service():
    assert module.__all__ == ["MatchingService"]
    assert hasattr(module, "MatchingService")
